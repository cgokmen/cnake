...
OFILES = main.o myLib.o splash.o font.o gbaGraphics.o cnakeLogic.o cnakeGraphics.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = main.h myLib.h splash.h gbaGraphics.h cnakeLogic.h cnakeGraphics.h cnakeSettings.h
